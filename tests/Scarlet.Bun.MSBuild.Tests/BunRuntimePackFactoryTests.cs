...
/// <summary>
/// Covers <see cref="BunRuntimePackFactory"/>, the only part of the pack contract that speaks MSBuild.
/// </summary>
public class BunRuntimePackFactoryTests
{
    ...
    {
        // Act
        var packs = BunRuntimePackFactory.FromTaskItems(null);
    ...
    public void FromTaskItems_ShouldReadAllMetadata()
    {
        ...
        // Act
        var pack = Assert.Single(BunRuntimePackFactory.FromTaskItems(items));
    ...
    public void FromTaskItems_WithMissingRequiredMetadata_ShouldSkipAndReport(string? rid, string? runtimesPath, string expectedMetadataName)
    {
        ...
        // Act
        var packs = BunRuntimePackFactory.FromTaskItems(items, reported.Add);
    ...
    public void FromTaskItems_WithNonNumericPriority_ShouldFallBackToZeroAndReport()
    {
        ...
        // Act
        var pack = Assert.Single(BunRuntimePackFactory.FromTaskItems(items, reported.Add));
