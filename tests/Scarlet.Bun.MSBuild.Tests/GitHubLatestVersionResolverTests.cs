...
{
    private const string LatestUrl = "https://github.com/oven-sh/bun/releases/latest/download/bun-linux-x64.zip";
    ...
    [Theory]
    [InlineData("https://github.com/oven-sh/bun/releases/download/bun-v1.4.2/bun-windows-x64.zip", "1.4.2")]
